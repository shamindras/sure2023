---
title: "Introduction to variable selection"
date: "2023-06-23"
---
...
slide_buttons("/slides/14-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/14-slides.Rmd
dname="14-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/14-slides.pdf" title="Lecture 1"></iframe>
```
