...
slide_buttons("/slides/15-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/15-slides.Rmd
dname="15-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/15-slides.pdf" title="Lecture 1"></iframe>
```
