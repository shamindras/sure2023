...
```
{{\< downloadthis ../slides/02-slides.Rmd
dname="02-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/02-slides.pdf" title="Lecture 1"></iframe>
```
