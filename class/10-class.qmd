...
slide_buttons("/slides/10-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/10-slides.Rmd
dname="10-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/10-slides.pdf" title="Lecture 1"></iframe>
```
