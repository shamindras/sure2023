...
slide_buttons("/slides/20-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/20-slides.Rmd
dname="20-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/20-slides.pdf" title="Lecture 1"></iframe>
```
