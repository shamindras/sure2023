...
slide_buttons("/slides/04-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/04-slides.Rmd
dname="04-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/04-slides.pdf" title="Lecture 1"></iframe>
```
