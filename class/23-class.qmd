---
title: "Kernels, Smoothers, and Generalized Additive Models"
date: "2023-07-11"
---
...
slide_buttons("/slides/23-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/23-slides.Rmd
dname="23-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/23-slides.pdf" title="Lecture 1"></iframe>
```
