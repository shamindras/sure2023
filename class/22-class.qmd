...
slide_buttons("/slides/22-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/22-slides.Rmd
dname="22-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/22-slides.pdf" title="Lecture 1"></iframe>
```
