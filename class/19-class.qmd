---
title: "K-Nearest Neighbors Regression and Classification"
date: "2023-06-05"
---
...
slide_buttons("/slides/19-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/19-slides.Rmd
dname="19-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/19-slides.pdf" title="Lecture 1"></iframe>
```
