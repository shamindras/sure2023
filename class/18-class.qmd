...
slide_buttons("/slides/18-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/18-slides.Rmd
dname="18-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/18-slides.pdf" title="Lecture 1"></iframe>
```
