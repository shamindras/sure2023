...
slide_buttons("/slides/21-slides", output_type = "pdf")
```
{{\< downloadthis ../slides/21-slides.Rmd
dname="21-slides" label="Download Rmd of all slides" icon="file-earmark"
type="success" \>}}

```{=html}
<iframe width="780" height="500" src="/slides/21-slides.pdf" title="Lecture 1"></iframe>
```
