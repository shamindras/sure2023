...
- [**Class**](/class/index.qmd) ({{< fa book-open-reader >}}): This page contains the readings for the class session. Read these **before** our in-person class.

- [**Assignment**](/assignment/index.qmd) ({{< fa pen-ruler >}}): This page contains the instructions for each assignment.
