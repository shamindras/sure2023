...
Here's your roadmap for the semester!
  ...
  - [**Lecture**](/class/index.qmd) ({{\< fa book-open-reader \>}}): This page
    contains the readings for the class session. These materials will typically 
    be released _right_ before each class, and in some cases, _directly after_ the 
    class.

  - [**Assignment**](/assignment/index.qmd) ({{\< fa pen-ruler \>}}): This page
    contains the instructions for each assignment, i.e., demo-lab or final research project materials.
