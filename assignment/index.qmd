...
You can also download the Quarto Markdown (`.qmd`) demo-lab files using the 
convenient links below:

::: {.callout appearance="minimal"}
<i class="bi bi-download"></i> [Demo Lab 1 (Intro to `R`)](demo-lab-01.qmd){download="demo-lab-01.qmd"}
:::
